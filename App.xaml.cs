...
namespace PanoramaApp1
{
    ...
    public partial class App : Application
    {
        ...
        /// </summary>
        /// <returns>Frame radice dell'applicazione Windows Phone.</returns>
        ...
        public App()
        {
            ...
            if (Debugger.IsAttached)
            {
                ...
                // Visualizza le aree dell'applicazione che vengono ridisegnate in ogni frame.
        ...
        // con il file selezionato o altri valori restituiti
        ...
        private void InitializePhoneApplication()
        {
            ...
            // Creare il frame ma non impostarlo ancora come RootVisual; in questo modo
            ...
            // Gestire l'attivazione del contratto, ad esempio l'apertura o la selezione e il salvataggio di un file
        ...
        private void InitializeLanguage()
        {
            ...
            catch
            {
                ...
                // ResourceLanguage non impostato correttamente su un codice lingua supportato
